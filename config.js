...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Minnal Bot Rishad CP' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'RISHAD CP' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴍɪɴɴᴀʟ࿐' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://bit.ly/3pndGqn' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://t.me/Legend_god001' : process.env.SOCIAL_MEDIA,
