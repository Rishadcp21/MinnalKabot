...
module.exports = {
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴛᴀᴜʀᴜs࿐' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://bit.ly/3DOgLpP' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/taurus_mp4/' : process.env.SOCIAL_MEDIA,
